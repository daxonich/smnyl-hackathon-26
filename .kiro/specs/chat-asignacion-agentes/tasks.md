...
- [-] 1. Inicializar estructura del proyecto y dependencias
...
- [ ] 2. Definir modelos de datos, constantes NSE y base de datos
  - [ ] 2.1 Crear interfaces TypeScript y constantes NSE
  ...
  - [ ] 2.2 Crear módulo de base de datos SQLite
  ...
  - [ ] 2.3 Crear seed script para generar 50+ agentes
...
- [ ] 3. Implementar validadores y clasificación NSE
  - [ ] 3.1 Crear módulo de validadores
  ...
  - [ ] 3.2 Crear función de clasificación NSE
...
- [ ] 4. Checkpoint — Verificar que modelos, validadores y seed funcionan
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Implementar el Flow Engine (máquina de estados conversacional)
  - [ ] 5.1 Crear el motor de flujo conversacional
...
- [ ] 6. Implementar el Motor de Asignación
  - [ ] 6.1 Crear el motor de asignación con scoring ponderado
...
- [ ] 7. Checkpoint — Verificar flow engine y motor de asignación
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Crear API REST del backend
  - [ ] 8.1 Implementar session manager y endpoints
